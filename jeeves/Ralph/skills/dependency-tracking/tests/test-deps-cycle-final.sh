...
test_cli_detect_cycle_cyclic() {
    ...
    test_assert_exit_code 0 "/proj/jeeves/Ralph/skills/dependency-tracking/scripts/deps-cycle.sh --detect-cycle 0001 returns exit code 0 on cyclic graph" \
        bash -c "DEPS_FILE='$DEPS_FILE' /proj/jeeves/Ralph/skills/dependency-tracking/scripts/deps-cycle.sh --detect-cycle 0001"
}
...
test_cli_validate_graph_valid() {
    ...
    test_assert_exit_code 1 "/proj/jeeves/Ralph/skills/dependency-tracking/scripts/deps-cycle.sh --validate-graph returns exit code 1 on valid graph" \
        bash -c "DEPS_FILE='$DEPS_FILE' /proj/jeeves/Ralph/skills/dependency-tracking/scripts/deps-cycle.sh --validate-graph"
}
...
# Test 24: Missing task ID with --detect-cycle → no cycle found, exit 0
test_cli_missing_task_id() {
    setup_valid_graph
    test_assert_exit_code 0 "/proj/jeeves/Ralph/skills/dependency-tracking/scripts/deps-cycle.sh --detect-cycle returns exit code 0 (no cycle found)" \
        bash -c "DEPS_FILE='$DEPS_FILE' /proj/jeeves/Ralph/skills/dependency-tracking/scripts/deps-cycle.sh --detect-cycle"
}
