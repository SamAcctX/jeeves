...
- Are acceptance criteria specific about behavior without prescribing implementation? (AC should name behaviors and outcomes; library APIs, hook names, and component wrappers belong in Implementation Notes)
...
todowrite([
  ...
  { content: "Check acceptance criteria — specific, measurable, and implementation-agnostic? (no library APIs in AC)", status: "pending", priority: "high" },
